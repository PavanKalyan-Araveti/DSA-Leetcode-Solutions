package heap.KthSmallestNumber;
...
// using my own custom MaxHeap
    ...
    // creating new maxheap
//    PriorityQueue<Integer> myHeap = new PriorityQueue<>(k, Collections.reverseOrder());
//    for(int n: nums){
//        if(myHeap.size() < k){
//            myHeap.offer(n);
//        }
